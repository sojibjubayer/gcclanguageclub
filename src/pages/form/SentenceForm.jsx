...
const SentenceForm = () => {
  const [formData, setFormData] = useState({
    ...
    arabicSentence: "",
    arabic_bengaliTransliteration: "",
    hindiSentence: "",
    hindi_bengaliTransliteration: "",
    bengaliSentence: "",
  });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:5000/api/dailysentence", formData);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Vocabulary Fields */}
        {[
          { label: "Arabic Sentence", name: "arabicSentence" },
          { label: "Arabic → Bengali", name: "arabic_bengaliTransliteration" },
          { label: "Hindi Sentence", name: "hindiSentence" },
          { label: "Hindi → Bengali", name: "hindi_bengaliTransliteration" },
          { label: "Bengali Sentence", name: "bengaliSentence" },
